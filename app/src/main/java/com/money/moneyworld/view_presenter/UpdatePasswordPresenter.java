...
public class UpdatePasswordPresenter {
    private UpdatePassword view;

    public UpdatePasswordPresenter(UpdatePassword view) {
        this.view = view;
    }

    public void UpdatePassword(String  mobile,String Password){
        view.showHideProgress(true);
        Call<ResponseBody> userCall = AppUtils.getApi((Context)view).UpdatePassword(mobile,Password);
